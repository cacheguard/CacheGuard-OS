...
show-transparent-form()
{
    ...
    blankItemContent[0]=""
    blankItemContent[1]="internal auxiliary vpnipsec"
    ...
    listContent=${TRANSPARENT_WEB_LIST}
    test -n "${listContent}" || state=disabled

    show-title "Transparent Web Networks" "${state}" "transparent"
